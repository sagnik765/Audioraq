...
SHOWS_125_TRENDING: List[ShowBlueprint] = [
    ...
    ShowBlueprint("The Reg Stack", "law", "AI regulation, privacy, consumer protection, and creator rights", "in-house counsel, founders, compliance teams, and policy-curious listeners", "professional", "interview", "moderate", "educate", "clarity", ["AI liability", "AI media consent", "workplace AI", "creator rights", "consumer protection workflows", "antitrust"]),
