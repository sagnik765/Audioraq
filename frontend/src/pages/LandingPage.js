      ...
      <div className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl px-6 md:px-8 lg:px-12 opacity-0 animate-fade-in-up">
          ...
          <p className="text-base text-[#8A8A93] leading-relaxed max-w-xl mb-10">
            Stop competing with short-form content. PodcastHub is a dedicated platform where podcasters connect directly with listeners who are searching for exactly what you create.
          </p>
      ...
      <section className="py-24 px-6 md:px-8 lg:px-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 opacity-0 animate-fade-in-up stagger-1">
            <span className="text-xs uppercase tracking-[0.2em] font-semibold text-[#F5A623] mb-4 block">Why PodcastHub</span>
      ...
      <footer className="border-t border-[#27272A] py-8 px-6 md:px-8 lg:px-12">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-[#8A8A93]">PodcastHub</span>
          </div>
          <span className="text-xs text-[#8A8A93]">&copy; 2026 PodcastHub</span>
        </div>
      </footer>
    </div>
  );
